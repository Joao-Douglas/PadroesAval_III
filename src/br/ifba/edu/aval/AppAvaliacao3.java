...
import br.ifba.edu.aval.model.chain.ApuradorOrdemPassagem;
import br.ifba.edu.aval.model.chain.ApuradorRegistroChegada;
import br.ifba.edu.aval.model.chain.ApuradorTempoAtraso;
import br.ifba.edu.aval.model.chain.ApuradorTempoMaximo;
import br.ifba.edu.aval.model.chain.ApuradorTotalidadePrismas;
...
public class AppAvaliacao3 extends AppAvaliacaoBase{
	...
	public void apurarBoletimProva(BoletimProva boletimProva) {
		...
		apurador.addRegra(new ApuradorRegistroChegada());
		apurador.addRegra(new ApuradorTempoMaximo());
		apurador.addRegra(new ApuradorOrdemPassagem());
		apurador.addRegra(new ApuradorTotalidadePrismas());
		apurador.addRegra(new ApuradorTempoAtraso());
		...
		try {
			...
			System.err.println("Erro ao apurar boletim: " + e.getMessage());
		}			
	}
